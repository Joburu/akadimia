  ...
  if(anthropicKey){
    try{
      const res = await fetch("https://api.anthropic.com/v1/messages",{
        ...
        body:JSON.stringify({model:"claude-haiku-4-5-20251001",max_tokens:400,system:"You are EduBot, an AI tutor for AKADIMIA — a Kenyan academic platform. You specialise in "+field+". You understand English and Kiswahili. Keep answers concise, practical and relevant to East African students. Always encourage and support.",messages:[{role:"user",content:question}]})
      });
