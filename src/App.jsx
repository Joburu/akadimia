...
const AssignmentsView=({userField,role,userName,addNotif})=>{
  ...
  const createAssignment=async()=>{
    ...
    const payload={title:baseData.title,course_code:baseData.course_code,description:baseData.description,due_date:baseData.due_date?new Date(baseData.due_date+":00+03:00").toISOString():null,max_marks:baseData.max_marks,target_year:baseData.target_year,field:userField,file_url:fileUrl||null,assignment_type:assignment_type||"individual",group_size:group_size||3,allow_late:allow_late||false};
